...
<html>
   <head>
      <title>Riabu Global Sculpture Online Display & Sales</title>
      <meta charset="utf-8" />
   ...
   <body>
      ...
      <header id="header" class="alt" >
         <div class="logo"><a href="index.php">Riabu <span>Online Sculpture Display Shop</span></a></div>
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Design & Develop By Riabu Wholesale & Retail | Kijabe Kenya</div>
            &copy; Riabu Global Sculpture Online Display & Sales. All rights reserved.
         </div>
      </footer>
      <!-- Scripts -->
