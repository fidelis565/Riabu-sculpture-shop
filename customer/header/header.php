...
<html lang="en">
  ...
  <head>
   ...
   <title>Customer - <?php echo $_SESSION["name"]; ?> - Riabu Global Sculpture & Fine Art</title>
...
<nav class="#header" >
  ...
  <!-- Header -->
			...
			<header id="header" class="alt" >
				...
				<div class="logo"><a href="index.php">Riabu Online <span>Sculpture & Fine Art</span></a></div>
