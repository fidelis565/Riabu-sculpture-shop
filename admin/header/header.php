...
">
<head>
<title>Admin - <?php echo $_SESSION["admin"]; ?> - Riabu Online Sculptures & Fine Art</title>
<meta charset="utf-8">
...
<nav class="#header">
  ...
  <!-- Header -->
			<header id="header" class="alt">
				<div class="logo"><a href="index.php">Riabu Global <span>Sculptures &amp; Fine Art</span></a></div>
